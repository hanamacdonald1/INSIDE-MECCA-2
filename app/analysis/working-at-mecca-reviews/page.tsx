    ...
    <article className="analysis-article">
      ...
      <div className="analysis-body">
        ...
        <section>
          ...
          <p>Ratings and review counts change, so this page links to the live source rather than freezing a score that may quickly become outdated. Inside MECCA does not treat a platform&apos;s aggregate rating as a prevalence estimate or an independent finding.</p>
          <ul className="analysis-sources">
            <li><a href="https://au.seek.com/companies/mecca-brands-813817/reviews" target="_blank" rel="noreferrer"><strong>SEEK employee reviews</strong><span>Individual reviews and category ratings, published under SEEK&apos;s platform rules.</span></a></li>
            ...
            <li><a href="https://au.indeed.com/cmp/Mecca-Brands/reviews?ftopic=culture" target="_blank" rel="noreferrer"><strong>Indeed culture reviews</strong><span>Employee-submitted reviews filtered around workplace culture.</span></a></li>
            <li><a href="https://www.glassdoor.com.au/Reviews/Mecca-Brands-Reviews-E876238.htm" target="_blank" rel="noreferrer"><strong>Glassdoor reviews</strong><span>Employee reviews and ratings across culture, management and other workplace categories.</span></a></li>
          </ul>
