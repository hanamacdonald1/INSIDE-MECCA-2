...
export default function Documentary(){return <SitePage>
  <PageHero label="Documentary interviews" title="There is a person behind every record" dark><p>The questionnaire helps us collect structured evidence. An interview has a different purpose: to understand what a workplace experience meant to the person who lived it, in their own voice.</p><p>You can ask about an interview without agreeing to be recorded, identified or published.</p><div className="rb-actions"><a className="rb-button red" href="mailto:insidemecca@mail2australia.com?subject=Documentary%20Interview">Ask about an interview</a><Link className="rb-button" href="/share-story/research-questionnaire">Use the research questionnaire</Link></div></PageHero>
